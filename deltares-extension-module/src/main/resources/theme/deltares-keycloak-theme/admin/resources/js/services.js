...
module.factory('Mailing', function($resource) {
    return $resource(authUrl + '/realms/:realm/mailing-provider/admin/:mailingId', {
        realm : '@realm',
        userId : '@mailingId'
    }, {
        update : {
...
module.service('MailingSearchState', function() {
    this.isFirstSearch = true;
    this.query = {
        max : 20,
        first : 0
