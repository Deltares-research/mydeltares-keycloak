...
<head>
    ...
    <script src="${resourceUrl}/js/controllers/mailings.js" type="text/javascript"></script>
    <script src="${resourceUrl}/js/controllers/attributes.js" type="text/javascript"></script>
