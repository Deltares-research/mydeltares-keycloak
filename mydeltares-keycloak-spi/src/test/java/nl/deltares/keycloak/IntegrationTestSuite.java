...
public class IntegrationTestSuite {
    ...
    public static void startKeyCloak() throws Throwable {
        ...
        Files.copy(new File(testResources, "keycloak/providers/mydeltares-keycloak-spi-3.0.jar").toPath(), new File(deploymentDir, "mydeltares-keycloak-spi-3.0.jar").toPath());
