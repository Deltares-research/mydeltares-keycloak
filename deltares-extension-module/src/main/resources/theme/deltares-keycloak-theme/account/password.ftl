...
<@layout.mainLayout active='password' bodyClass='password'; section>
    ...
    <form action="${url.passwordUrl}" onsubmit="validateCredentials(event, ${ppolicy.minLength}, ${ppolicy.minDigits}, ${ppolicy.minUpperCase}, ${ppolicy.minLowerCase},
    ${ppolicy.minSpecialChars});" class="form-horizontal" method="post">
