...
module.config([ '$routeProvider', function($routeProvider) {
    $routeProvider
        ...
        .when('/create/mailing/:realm', {
            templateUrl : resourceUrl + '/partials/mailing-detail.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
            ...
            controller : 'MailingDetailCtrl'
        })
        .when('/load/mailing/:realm/:mailing', {
            templateUrl : resourceUrl + '/partials/mailing-detail.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
                mailing : function(MailingLoader) {
                    return MailingLoader();
                }
            },
            controller : 'MailingDetailCtrl'
        })
        ...
        .when('/realms/:realm/mailings', {
            templateUrl : resourceUrl + '/partials/mailing-list.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                }
...
module.directive('kcTabsMailings', function () {
    return {
        scope: true,
        restrict: 'E',
        replace: true,
        templateUrl: resourceUrl + '/templates/kc-tabs-mailings.html'
    }
});

module.directive('kcTabsMailing', function () {
    return {
        scope: true,
        restrict: 'E',
        replace: true,
        templateUrl: resourceUrl + '/templates/kc-tabs-mailing.html'
    }
});
